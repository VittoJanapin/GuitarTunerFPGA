...
# ACDS 18.0 614 win32 2025.11.10.18:04:22
...
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="C:/desl/quartus18/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/../src/fft_ii_0_example_design_core_1n8192cos.hex ./
  cp -f $QSYS_SIMDIR/../src/fft_ii_0_example_design_core_1n8192sin.hex ./
  cp -f $QSYS_SIMDIR/../src/fft_ii_0_example_design_core_2n8192cos.hex ./
  cp -f $QSYS_SIMDIR/../src/fft_ii_0_example_design_core_2n8192sin.hex ./
  cp -f $QSYS_SIMDIR/../src/fft_ii_0_example_design_core_3n8192cos.hex ./
  cp -f $QSYS_SIMDIR/../src/fft_ii_0_example_design_core_3n8192sin.hex ./
...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/../src/auk_dspip_text_pkg.vhd"                    -work work
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/../src/auk_dspip_math_pkg.vhd"                    -work work
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/../src/auk_dspip_lib_pkg.vhd"                     -work work
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/../src/auk_dspip_roundsat.vhd"                    -work work
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/../src/auk_dspip_avalon_streaming_sink.vhd"       -work work
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/../src/auk_dspip_avalon_streaming_source.vhd"     -work work
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS             "$QSYS_SIMDIR/../src/auk_dspip_avalon_streaming_controller.vhd" -work work
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/avalon_utilities_pkg.sv"                   -work work
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/verbosity_pkg.sv"                          -work work
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/altera_avalon_clock_source.sv"             -work work
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/altera_avalon_reset_source.sv"             -work work
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/altera_avalon_st_sink_bfm.sv"              -work work
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/altera_avalon_st_source_bfm.sv"            -work work
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../src/fft_ii_0_example_design.v"                 -work work
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/fft_ii_0_example_design_core.sv"           -work work
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../src/fft_ii_0_example_design_tb.v"              -work work
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/fft_ii_0_example_design_test_program.sv"   -work work
fi
